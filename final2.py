...
# Define the list of country acronyms
country_dict = list(df_countries['Acronym'])

# Ask the user to input a country acronym
country_acronym = st.text_input("Enter a country acronym (e.g. USA, CAN, MEX):")

# Validate the country acronym
if country_acronym.upper() not in country_dict:
    st.error("Invalid country acronym. Please enter a valid country acronym.")
else:
    # Get the country name from the dictionary
    country_name = country_dict[country_acronym.upper()]
    st.success(f"The selected country is: {country_name}")
